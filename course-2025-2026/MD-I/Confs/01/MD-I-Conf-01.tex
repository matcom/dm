...
%entonces $n+1\in S$ porque sino $n+1$ sería el minimo de A y este no tiene. Luego, por PIM, $S=\mathbb{N}$ y por tanto $A$ es vacío ¡lo que es una contradicción! Luego $A$ tiene un mínimo.\\
